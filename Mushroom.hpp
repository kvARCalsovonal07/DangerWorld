...
class Mushroom : public Mob {
    public:
        Mushroom(bool flip) : Mob(flip, sf::RectangleShape(sf::Vector2f(40, 70)), 50) {
            ...
            this->attackingArea = sf::RectangleShape(sf::Vector2f(140, 70));
            this->attackingArea.setFillColor(sf::Color(255, 0, 0, 150));

            this->followingArea = sf::RectangleShape(sf::Vector2f(340, 140));
            this->followingArea.setFillColor(sf::Color(255, 165, 0, 150));
        }

        // Mozgás
        void move(std::vector<Tile> &tiles) {
            this->hitbox.setPosition(this->x, this->y);
            this->sprite.setPosition(this->x - 130, this->y - 132);
            this->attackingArea.setPosition(this->x - 50, this->y);
            this->followingArea.setPosition(this->x - 150, this->y - 70);
        ...
        void update() {
            ...
            if (alive) {
                ...
                if ((attackingCooldown > 0 && !attacking) || (!attacking && attackingCooldown < 1 && !takeHit)) {
                    action = 0;
                }
        ...
        void draw(sf::RenderTarget& target, sf::RenderStates states) const override {
            target.draw(this->followingArea, states);
    ...
    private:
        ...
        sf::RectangleShape followingArea;
        ...
        // Az ütés
        void attack() {
            sf::RectangleShape attackingRect(sf::Vector2f(60, this->hitbox.getSize().y));
